...
if(board[row][column] == 'w') {
  ...
  if(old_board[row][column] != board [row][column]) {
    if(old_board[row][column] == '?' && board[row][column] == ' ') {
      ...
      $('#'+row+'_'+column).html('<img src="assets/images/blue_to_black.gif" alt="black square"/>');
    }
    else if(old_board[row][column] == 'b' && board[row][column] == 'w') {
      $('#'+row+'_'+column).html('<img src="assets/images/black_to_blue.gif" alt="blue square"/>');
    }
    else{
...
socket.on('play_token_response',function(payload) {
 console.log('*** Client Log Message: \'game_token_response\'\n\tpayload: '+JSON.stringify(payload));
